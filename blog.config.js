...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '周期因子', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '0-1助力打好动作基础，唤醒身体感知力', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://movebycode.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Movement,Self-Care,Holistic Health', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'chelseachooow@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIXIN: process.env.NEXT_PUBLIC_CONTACT_WEICHAT || '', // 你的微信个人主页
